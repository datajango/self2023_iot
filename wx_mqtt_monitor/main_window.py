...
import wx
from wx_mqtt_monitor.connection_dialog_v2 import ConnectionDialog
import paho.mqtt.client as mqtt
from wx_mqtt_monitor.mqtt_client import MqttClient
...
class MainWindow(wx.Frame): 
    def __init__(self, parent, title, config_manager, logger): 
        ...
        # add the following line to center the window
        self.Centre(wx.BOTH)
